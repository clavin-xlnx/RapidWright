...
public class RoutableNode implements Routable{
	...
	public int setChildren(int globalIndex, float base_cost_fac, Map<Node, RoutableNode> createdRoutable, Set<Node> reserved){
		this.children = new ArrayList<>();
		for(Node node:this.node.getAllDownhillNodes()){
			if(node.getTile().getName().startsWith("INT_")){
